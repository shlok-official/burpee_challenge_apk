 ...
 */
public class ScrollingView_wg extends View {
   private Drawable mBackground;
   private int mScrollPos;

   public ScrollingView_wg(Context context) {
      super(context);
      init(null, 0);
   }

   public ScrollingView_wg(Context context, AttributeSet attrs) {
      super(context, attrs);
      init(attrs, 0);
   }

   public ScrollingView_wg(Context context, AttributeSet attrs, int defStyle) {
